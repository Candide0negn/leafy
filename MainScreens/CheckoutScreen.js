      ...
      >
        <ScrollView>
          ...
          {isDelivery && (
            <View>
              <TouchableOpacity
                style={[styles.addressSection, { backgroundColor: "#CBEEBC" }]}
              ...
              >
                ...
                <Text>{orderDetails.deliveryAddress.fullName}</Text>
                <Text>{orderDetails.deliveryAddress.phone}</Text>
                <Text>{orderDetails.deliveryAddress.street}</Text>
                <Text>
                  {orderDetails.deliveryAddress.poBox} {orderDetails.deliveryAddress.city}
                </Text>
              </TouchableOpacity>
          ...
          {!isDelivery && (
            <View>
              <TouchableOpacity
                style={[styles.TempContainer, { backgroundColor: "#CBEEBC" }]}
              >
                <Text style={{ textAlign: "center" }}>Google Maps</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
                  styles.ClubAddressSection,
          ...
          <TouchableOpacity
            style={[styles.itemSection, { backgroundColor: "#CBEEBC" }]}
          ...
          <TouchableOpacity
            style={[styles.discountSection, { backgroundColor: "#CBEEBC" }]}
          ...
          <View style={[styles.subtotalsSection]}>
            <Text style={[styles.subtotalText, { textAlign: "left" }]}>
              Subtotal
            </Text>
          ...
          <Text style={styles.disclaimerText}>
            Disclaimer text. Disclaimer text. Disclaimer text. Disclaimer text.
            Disclaimer text. Disclaimer text. Disclaimer text. Disclaimer text.
            Disclaimer text. Disclaimer text. Disclaimer text. Disclaimer text.
            Disclaimer text. Disclaimer text. Disclaimer text. Disclaimer text.
            Disclaimer text. Disclaimer text. Disclaimer text. Disclaimer text.
            Disclaimer text. Disclaimer text. Disclaimer text. Disclaimer text.
            Disclaimer text. Disclaimer text. Disclaimer text.
          </Text>
        </ScrollView>
      </Animated.View>
